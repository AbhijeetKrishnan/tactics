...
to_coords(d1, 4, 1). to_coords(d2, 4, 2). to_coords(d3, 4, 3). to_coords(d4, 4, 4). to_coords(d5, 4, 5). to_coords(d6, 4, 6). to_coords(d7, 4, 7). to_coords(d8, 4, 8).
to_coords(e1, 5, 1). to_coords(e2, 5, 2). to_coords(e3, 5, 3). to_coords(e4, 5, 4). to_coords(e5, 5, 5). to_coords(e6, 5, 6). to_coords(e7, 5, 7). to_coords(e8, 5, 8).
to_coords(f1, 6, 1). to_coords(f2, 6, 2). to_coords(f3, 6, 3). to_coords(f4, 6, 4). to_coords(f5, 6, 5). to_coords(f6, 6, 6). to_coords(f7, 6, 7). to_coords(f8, 6, 8).
to_coords(g1, 7, 1). to_coords(g2, 7, 2). to_coords(g3, 7, 3). to_coords(g4, 7, 4). to_coords(g5, 7, 5). to_coords(g6, 7, 6). to_coords(g7, 7, 7). to_coords(g8, 7, 8).
to_coords(h1, 8, 1). to_coords(h2, 8, 2). to_coords(h3, 8, 3). to_coords(h4, 8, 4). to_coords(h5, 8, 5). to_coords(h6, 8, 6). to_coords(h7, 8, 7). to_coords(h8, 8, 8).
